  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "kesher-navy": "hsl(var(--kesher-navy))",
        "kesher-blue": "hsl(var(--kesher-blue))",
        "kesher-blue-dark": "hsl(var(--kesher-blue-dark))",
        "kesher-sky": "hsl(var(--kesher-sky))",
        "kesher-grey": "hsl(var(--kesher-grey))",
        "kesher-accent": "hsl(var(--kesher-accent))",
        sidebar: {
